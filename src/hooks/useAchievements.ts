...
export interface AchievementStats {
  ...
  maxWpmAchieved: number;
  dailyTypingMinutes: number;
  firstTimeEasterEgg: boolean;
}
...
export const useAchievements = (username: string) => {
  ...
  const allAchievements: Achievement[] = [
    ...
    },
    {
      ...
      getProgress: (stats) => ({ current: Math.min(stats.maxWpmAchieved, 50), max: 50 })
    },
    {
      id: 'you-are-not-slow-anymore',
      ...
      getProgress: (stats) => ({ current: Math.min(stats.maxWpmAchieved, 60), max: 60 })
    },
    {
      id: 'typist-on-rise',
      ...
      getProgress: (stats) => ({ current: Math.min(stats.maxWpmAchieved, 70), max: 70 })
    },
    {
      id: 'speed-class',
      ...
      getProgress: (stats) => ({ current: Math.min(stats.maxWpmAchieved, 80), max: 80 })
    },
    {
      id: 'ninety-nine',
      ...
      getProgress: (stats) => ({ current: stats.maxWpmAchieved >= 99 ? 99 : Math.min(stats.maxWpmAchieved, 99), max: 99 })
    },
    {
      id: 'hundred-club',
      ...
      getProgress: (stats) => ({ current: Math.min(stats.maxWpmAchieved, 100), max: 100 })
    },
    {
      id: 'the-one',
      name: 'The One',
      ...
      getProgress: (stats) => ({ current: Math.min(stats.maxWpmAchieved, 150), max: 150 })
    },
    {
      id: 'global-menace',
      name: 'Global Menace',
      ...
      getProgress: (stats) => ({ current: Math.min(stats.maxWpmAchieved, 180), max: 180 })
    },
    {
      id: 'sniper-hands',
      name: 'Sniper Hands',
    ...
    },
    {
      ...
      description: 'Maintain a 7-day daily usage streak.',
    ...
    },
    {
      ...
      description: 'Visit the app 50 total days.',
      category: 'consistency',
      wpm: 0,
      unlocked: false,
    ...
    },
    {
      ...
      description: 'Visit the app 100 total days.',
      category: 'consistency',
      wpm: 0,
      unlocked: false,
    ...
    },
    {
      ...
      wpm: 0,
      unlocked: false,
      condition: (stats) => stats.dailyTypingMinutes >= 120,
      getProgress: (stats) => ({ current: Math.min(stats.dailyTypingMinutes, 120), max: 120 })
    },
    {
      id: 'hour-power',
      ...
      wpm: 0,
      unlocked: false,
      condition: (stats) => stats.dailyTypingMinutes >= 60,
      getProgress: (stats) => ({ current: Math.min(stats.dailyTypingMinutes, 60), max: 60 })
    },
    {
      id: 'ultimate-grind',
      ...
      wpm: 0,
      unlocked: false,
      condition: (stats) => stats.dailyTypingMinutes >= 300,
      getProgress: (stats) => ({ current: Math.min(stats.dailyTypingMinutes, 300), max: 300 })
    },
    {
      id: 'wait-that-works',
      ...
      wpm: 0,
      unlocked: false,
      condition: (stats) => stats.cheatUsages >= 1,
      getProgress: (stats) => ({ current: Math.min(stats.cheatUsages, 1), max: 1 })
    },
    {
      ...
      wpm: 0,
      unlocked: false,
      condition: (stats) => stats.cheatUsages >= 10,
      getProgress: (stats) => ({ current: Math.min(stats.cheatUsages, 10), max: 10 })
    },
    {
      ...
      wpm: 0,
      unlocked: false,
      condition: (stats) => stats.cheatUsages >= 50,
      getProgress: (stats) => ({ current: Math.min(stats.cheatUsages, 50), max: 50 })
    },
    {
      ...
      wpm: 0,
      unlocked: false,
      condition: (stats) => stats.cheatUsages >= 100,
      getProgress: (stats) => ({ current: Math.min(stats.cheatUsages, 100), max: 100 })
    },
    {
      id: 'you-found-it',
      name: 'You Found It',
      subtitle: 'What were you hoping for? Definitely not this',
      description: 'Visit the easter egg for the first time.',
      category: 'fun',
      wpm: 0,
      unlocked: false,
      condition: (stats) => stats.firstTimeEasterEgg
    },
    {
  ...
  const checkAchievements = (stats: AchievementStats) => {
    const updatedAchievements = achievements.map(achievement => {
      ...
      if (achievement.getProgress && !achievement.unlocked) {
